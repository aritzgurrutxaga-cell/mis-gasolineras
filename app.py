...
st.markdown("""
    <style>
        ...
        div[data-testid="stVerticalBlock"] > div:has(div[data-testid="stSelectSlider"]) {
            margin-top: 1.2rem;
        }
        /* Ajuste para el select_slider */
        div[data-testid="stSelectSlider"] {margin-bottom: -1rem;}
        
        /* Ajuste para los radio buttons de combustible */
...
if datos:
    ...
    # Cambiado a select_slider con tus bullets específicos
    radio_km = st.select_slider(
